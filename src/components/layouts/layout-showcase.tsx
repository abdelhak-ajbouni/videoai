                ...
                {[
                  ...
                  <div key={container.size} className="space-y-2">
                    ...
                    <div className="relative bg-surface-elevated rounded-lg p-4 border border-border">
                      <Container size={container.size as any} className="bg-ai-primary-50 dark:bg-ai-primary-900/20 rounded-lg p-4 border border-ai-primary-200 dark:border-ai-primary-800">
                  ...
                  {[
                    ...
                    <div key={item.padding} className="space-y-2">
                      ...
                      <div className="bg-surface-elevated rounded-lg border border-border overflow-hidden">
                        <Container size="full" padding={item.padding as any} className="bg-ai-electric-50 dark:bg-ai-electric-900/20 py-3">
              ...
              <CardContent className="space-y-6">
                {[
                  ...
                  <div key={grid.cols} className="space-y-2">
                    ...
                    <Grid cols={grid.cols as any} gap={4}>
              ...
              <CardContent className="space-y-6">
                {[
                  ...
                  <div key={grid.preset} className="space-y-3">
                    ...
                    <Grid responsive={grid.preset as any} gap={4}>
              ...
              <CardContent className="space-y-4">
                {[
                  ...
                  <div key={section.bg} className="space-y-2">
                    ...
                    <Section background={section.bg as any} spacing="sm" className="rounded-lg">
